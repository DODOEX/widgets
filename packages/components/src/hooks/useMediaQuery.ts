...
import { getThemeProps, Theme, useThemeWithoutDefault as useTheme } from '@mui/system';
...
export default function useMediaQuery(
  ...
  const {
    ...
    ssrMatchMedia = null,
    noSsr,
  } = getThemeProps({ name: 'MuiUseMediaQuery', props: options, theme: theme || undefined });
  ...
  let query = typeof queryInput === 'function' ? queryInput(theme as unknown as Theme) : queryInput;
