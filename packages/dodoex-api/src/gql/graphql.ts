...
export type Ve33_GetTicksDataQueryVariables = Exact<{
  where?: InputMaybe<Ve33getTicksDataInput>;
}>;

export type Ve33_GetTicksDataQuery = {
  ve33_getTicksData: {
    ticks: Array<{
      id: string;
      poolAddress: string;
...
>;
export const Ve33_Token_ListDocument = new TypedDocumentString(`
  ...
  ve33_token_list(where: $where) {
    ...
    `) as unknown as TypedDocumentString<
  Ve33_Token_ListQuery,
  Ve33_Token_ListQueryVariables
>;
...
>;
export const Ve33_GetTicksDataDocument = new TypedDocumentString(`
