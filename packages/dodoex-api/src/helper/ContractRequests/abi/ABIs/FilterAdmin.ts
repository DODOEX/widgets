export default [
  ...
  {
    inputs: [{ internalType: 'address[]', name: 'filters', type: 'address[]' }],
    name: 'addFilter',
    outputs: [],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address[]', name: 'filters', type: 'address[]' },
    ],
    name: 'init',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{ internalType: 'address', name: 'filter', type: 'address' }],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'afterChargedAmount', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
