...
const abi: ContractInterface = [
  {
    inputs: [
      { internalType: 'address', name: 'dspFactory', type: 'address' },
      { internalType: 'address', name: 'gspFactory', type: 'address' },
  ...
  {
    inputs: [
      { internalType: 'address', name: 'dspAddress', type: 'address' },
  ...
  },
  {
    ...
    name: 'createSETTLEXGasSavingPair',
    outputs: [
      { internalType: 'address', name: 'newGasSavingPair', type: 'address' },
      { internalType: 'uint256', name: 'shares', type: 'uint256' },
    ],
    stateMutability: 'payable',
    type: 'function',
  },
  {
    ...
    name: 'createSETTLEXStablePair',
    outputs: [
      {
        internalType: 'address',
        name: 'newSETTLEXStablePair',
        type: 'address',
      },
      { internalType: 'uint256', name: 'shares', type: 'uint256' },
    ],
