...
const spec: ContractInterface = [
  ...
  },
  {
    inputs: [],
    name: '_R_STATUS_',
    outputs: [{ internalType: 'enum Types.RStatus', name: '', type: 'uint8' }],
    stateMutability: 'view' as const,
    type: 'function' as const,
  },
  {
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256', name: 'lpBalance', type: 'uint256' }],
    stateMutability: 'view' as const,
    type: 'function' as const,
  },
  {
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256', name: 'payQuote', type: 'uint256' }],
    stateMutability: 'view' as const,
    type: 'function' as const,
  },
  {
