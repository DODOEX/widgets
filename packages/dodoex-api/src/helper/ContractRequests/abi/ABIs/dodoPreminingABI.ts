...
const spec: ContractInterface = [
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_startReleaseTime', type: 'uint256' },
      { internalType: 'uint256', name: '_releaseDuration', type: 'uint256' },
      { internalType: 'uint256', name: '_cliffRate', type: 'uint256' },
    ],
  ...
  {
    inputs: [
      { internalType: 'address[]', name: 'holderList', type: 'address[]' },
