...
const abis: ContractInterface = [
  ...
  {
    inputs: [{ internalType: 'string', name: 'newFilterName', type: 'string' }],
    name: 'changeFilterName',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'maxNFTAmount', type: 'uint256' },
      { internalType: 'uint256', name: 'minNFTAmount', type: 'uint256' },
    ],
    name: 'changeNFTAmountRange',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'newGsStart', type: 'uint256' },
      { internalType: 'uint256', name: 'newCr', type: 'uint256' },
      { internalType: 'bool', name: 'toggleFlag', type: 'bool' },
    ],
    name: 'changeNFTInPrice',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'nftIdStart', type: 'uint256' },
      { internalType: 'uint256', name: 'nftIdEnd', type: 'uint256' },
    ],
    name: 'changeTokenIdRange',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'address', name: 'filterAdmin', type: 'address' },
      { internalType: 'address', name: 'nftCollection', type: 'address' },
      { internalType: 'bool[]', name: 'toggles', type: 'bool[]' },
      { internalType: 'string', name: 'filterName', type: 'string' },
      { internalType: 'uint256[]', name: 'numParams', type: 'uint256[]' },
      { internalType: 'uint256[]', name: 'priceRules', type: 'uint256[]' },
      { internalType: 'uint256[]', name: 'spreadIds', type: 'uint256[]' },
    ],
    name: 'init',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{ internalType: 'uint256', name: 'NFTInAmount', type: 'uint256' }],
    name: 'queryNFTIn',
    outputs: [
      { internalType: 'uint256', name: 'rawReceive', type: 'uint256' },
  ...
  {
    inputs: [
      { internalType: 'uint256', name: 'NFTOutAmount', type: 'uint256' },
    ],
    name: 'queryNFTRandomOut',
    outputs: [
      { internalType: 'uint256', name: 'rawPay', type: 'uint256' },
