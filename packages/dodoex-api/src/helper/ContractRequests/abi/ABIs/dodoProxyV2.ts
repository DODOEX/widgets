...
const abi: ContractInterface = [
  {
    inputs: [
      ...
      { internalType: 'address', name: 'settlexSellHelper', type: 'address' },
    ],
  ...
  },
  {
    ...
    name: 'createSETTLEXVendingMachine',
    outputs: [
      { internalType: 'address', name: 'newVendingMachine', type: 'address' },
      { internalType: 'uint256', name: 'shares', type: 'uint256' },
    ],
    stateMutability: 'payable',
    type: 'function',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'fromTokenAmount', type: 'uint256' },
      { internalType: 'uint256', name: 'minReturnAmount', type: 'uint256' },
      { internalType: 'address[]', name: 'settlexPairs', type: 'address[]' },
  ...
  },
  {
    ...
    name: 'settlexSwapV2TokenToToken',
    outputs: [
      { internalType: 'uint256', name: 'returnAmount', type: 'uint256' },
    ],
    stateMutability: 'nonpayable',
