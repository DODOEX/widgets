  ...
  return useMutation({
    mutationFn: async () => {
      ...
      try {
        ...
        const data = await encodeVE33V3GaugeDeposit(tokenId);
        const result = await submission.execute(
          ...
          {
            metadata: {
              [MetadataFlag.stakeVe33V3Position]: true,
            },
          },
        );
