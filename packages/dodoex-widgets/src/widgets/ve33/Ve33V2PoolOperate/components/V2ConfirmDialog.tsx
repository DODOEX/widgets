...
import { RatioPrice } from '../../../PoolWidget/AMMV2Create/Ratio';
      ...
      >
        ...
        >
          ...
          >
            ...
            {stable !== undefined && fee !== undefined && (
              <PoolTypeTag type={PoolTypeE.Pool} stable={stable} fee={fee} />
            )}
          </Box>
        </Box>
