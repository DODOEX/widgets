...
export const lightPalette: PaletteOptions = {
  ...
  text: {
    primary: '#1D1D1D',
    secondary: alpha('#1D1D1D', 0.5),
    disabled: alpha('#1D1D1D', 0.3),
    placeholder: alpha('#1D1D1D', 0.3),
    link: '#154618',
  },
  border: {
    main: alpha('#1D1D1D', 0.1),
    light: alpha('#1D1D1D', 0.3),
    disabled: alpha('#1D1D1D', 0.1),
  },
  hover: {
    default: alpha('#1D1D1D', 0.04),
  },
  tabActive: {
    main: alpha('#154618', 0.1),
    contrastText: '#154618',
  },
};
